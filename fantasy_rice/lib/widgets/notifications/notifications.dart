              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Opacity(
                      opacity:
                          Curves.easeOutExpo.flipped.transform(createdAC.value),
                      child: SizedBox(
                        width: 150,
                        height: 100,
                        child: Center(
                  ...
                  if (n.icon != null && File(n.icon!).existsSync())
                    Positioned(
                      left: 110,
                      top: 100,
                      child: Opacity(
                        opacity: Curves.easeOutExpo.transform(max(0.0, 2 * (createdAC.value - 0.5))),
                        child: SizedBox(
                          width: 220,
                          height: 80,
                          child: Center(
